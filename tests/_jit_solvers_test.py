...
class TestNewtonRaphson:
    ...
    def test_transcendental_function(self):
        ...
        scipy_root = optimize.newton(transcendental_nojit, x0=1.0, fprime=transcendental_prime_nojit)
    ...
    def test_exponential_function(self):
        ...
        root, iters, converged = _newton_raphson_scalar(
            exponential, exponential_prime, x0=1.0
        )
...
class TestNewtonRaphson:
    ...
    def test_custom_tolerance(self):
        ...
        tol = 1e-10
        root, iters, converged = _newton_raphson_scalar(
            quadratic, quadratic_prime, x0=3.0, tol=tol
        )
